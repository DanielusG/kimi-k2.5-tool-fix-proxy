...
```bash
git clone https://github.com/yourusername/kimi-tool-call-fixer.git
cd kimi-tool-call-fixer
SERVER_URL=https://your-api-endpoint/v1 docker compose up -d
```
...
SERVER_URL=https://your-api-endpoint/v1 python main.py
```
